...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-background gradient-mesh flex flex-col justify-center py-12 sm:px-6 lg:px-8 transition-theme">
      <div class="sm:mx-auto sm:w-full sm:max-w-md animate-fade-in">
        <div class="text-center">
          <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-primary-500 to-accent-500 shadow-lg mb-4 animate-scale-in">
            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
          </div>
          <h2 class="text-4xl font-bold bg-gradient-to-r from-primary-600 to-accent-600 bg-clip-text text-transparent">
            PDF Summarizer
          </h2>
      ...
      <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md animate-slide-up">
        <div class="glass rounded-2xl shadow-xl p-8 space-y-6">
          ...
          <div class="space-y-3">
            ...
            >
              <div class="absolute inset-0 bg-gradient-to-r from-primary-500/10 to-accent-500/10 opacity-0 group-hover:opacity-100 transition-opacity"></div>
          ...
          <div class="relative">
            ...
            <div class="relative flex justify-center text-xs">
              <span class="px-4 bg-card text-muted-foreground">Secure authentication</span>
            </div>
          </div>
      ...
      <div class="fixed bottom-4 right-4">
        <button (click)="toggleTheme()" 
          ...
          <svg *ngIf="!isDarkMode()" class="w-5 h-5 text-muted-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
