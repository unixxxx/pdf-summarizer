        ...
        >
          ...
          <div class="p-4 text-center text-muted-foreground">
            <div class="inline-flex items-center">
              <div
                class="w-4 h-4 border-2 border-primary-600 border-t-transparent rounded-full animate-spin mr-2"
              ></div>
              Loading chats...
            </div>
          </div>
            ...
            <div class="flex items-start justify-between">
              <div class="flex-1 min-w-0">
                ...
                <p class="text-xs text-muted-foreground mt-1 truncate">
                  {{ session.documentFilename || 'Document' }}
                </p>
              ...
              <div class="flex items-start gap-3">
                ...
                <div class="flex-1">
                  ...
                  <div class="mt-2 text-xs text-muted-foreground">
                    <details class="group">
                      <summary
                        class="cursor-pointer inline-flex items-center hover:text-foreground transition-colors"
                      >
                        <svg
                          class="w-3 h-3 mr-1"
                          fill="none"
                        ...
                        <svg
                          class="w-3 h-3 ml-1 transform transition-transform group-open:rotate-90"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                      ...
                      <div class="mt-2 pl-4 space-y-1">
                        @for (chunk of msg.metadata?.chunks_used || []; track
                        chunk.chunk_id; let i = $index) {
                        <div class="text-xs">
...
export class Chat implements OnInit {
  ...
  displayMessages = computed((): ChatMessageDisplay[] => {
    return this.currentMessages().map((msg) => ({
      ...
      displayName: msg.isUserMessage ? 'You' : 'Assistant',
      chunksCount: msg.chunksUsed,
  ...
  constructor() {
    ...
    effect(() => {
      ...
      if (error) {
        // Error is handled by the UI - clear after 5 seconds
